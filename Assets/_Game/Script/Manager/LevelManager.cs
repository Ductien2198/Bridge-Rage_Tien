...
{
    readonly List<ColorType> colorTypers = new List<ColorType>() { ColorType.Black, ColorType.Red, ColorType.Blue, ColorType.Green, ColorType.Yellow, ColorType.Orange, ColorType.Brown, ColorType.Violet  };
    ...
    public void OnInit()
    {
        ...
        //init random mau
        List<ColorType> colorDatas = Utillities.SortOrder(colorTypers, CharacterAmount);
    ...
    public void LoadLevel(int level)
    {
        ...
        else
        {
            ...
            currentLevel = Instantiate(levelPrefabs[level % levelPrefabs.Length]);
            currentLevel.OnInit();
        }
    }
